<%-- 
    Document   : Faulty Vehicle Not Reallocated
    Created on : Oct 2009
    Author     : Ayaz A.
    Discroption: This page shows the vehicles Which Are Faulty And For Them the Complaints Are not Re-Allocated
...
try
{
	...
	<!-- Excel -->	
	<tr><td align="right">  <a href="faultyvehnotrealloexcell.jsp?cust=<%=cust %>"> <img src="images/excel.jpg" width="15px" height="15px" border="0"/> </a> </div> </td></tr>
<!--  -->		
