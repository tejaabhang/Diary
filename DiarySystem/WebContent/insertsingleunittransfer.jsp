...
String rsndelay=request.getParameter("rsndelay");
//System.out.println(rsndelay);
...
response.sendRedirect("singleunittransfer.jsp?inserted=yes");
return;
