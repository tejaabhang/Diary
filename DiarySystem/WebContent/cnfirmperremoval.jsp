  ...
  <div id="outer">
	...
	<div id="gbox1">
            ...
            <div id="gbox-bg1">
              <div id="gbox-grd1">
<!--- code start here ------>
  <form name="removeunitform" method="get" action="permremovalinsrt.jsp" onsubmit="return validate();">
...
for(int k=0;k<counter;k++)
{
	int c=0;
			...
			unitid[k]=request.getParameter("unid"+k);
			vehreg[k] = request.getParameter("vehreg"+k );
			techname[k] = request.getParameter("techname"+k );
			cmnt[k] = request.getParameter("cmnt"+k );
 ...
 %>
		<tr>
		 ...
		 Transporter: </b></font>
  			...
  			<td>
				<input type="text" name="owner<%=k%>" value="<%=owner[k]%>" class="formElement" readonly />		
			</td>
		
			<td> <font size="2"><b> Vehicle Reg. No.:  </b></font>
			</td>
			<td>
				<input type="text" name="vehreg<%=k%>" value="<%=vehreg[k]%>" class="formElement" readonly />		
			</td>
		
			<td colspan="14" align="center">  <font size="2"><b>
		      Unit Id: </b></font> </td>
		 	<td>
  		      <input type="text" name="unid<%=k%>" size="8" value="<%=unitid[k]%>" class="formElement" readonly> </input> </div>
  		  	</td>
...
%>
			...
			<td>  <input type="text" name="techname<%=k%>" size="8" value="<%=techname[k]%>" class="formElement" readonly> </input> </div>
			</td>
		...
		<!-- <tr>
		 ...
		 <input type="radio" name="oldunitwith" value="Company">Company</input>
			...
			<td> 
			 <input type="text" name="cmnt<%=k%>" size="8" value="<%=cmnt[k]%>" class="formElement" readonly></textarea> </td>
...
<%
	...
	<tr><input type="hidden" name="cntr" value="<%=l%>"></input>
	 <td colspan="14" align="center"> <div align="center"> <input type="submit" name="submit" value="Remove" class="formElement"> </input> </div> </td> 
		</tr>
