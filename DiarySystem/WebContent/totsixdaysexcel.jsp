...
String filename="Six_Days_Delay_Data.xls";
...
//out.print(sql);
	...
	<%
		...
		%>
				<td><%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(compdate))%>		   
	<%		
		}
		else
		{ %>
