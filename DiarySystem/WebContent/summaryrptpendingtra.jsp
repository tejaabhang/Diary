...
<%-- <table  width="750px">
	...
	<%!String datex1, datex2, data1, data2,dt,dt1,Transp1,fromdate123,fromdate456,fromdate789,fromdate123000;
...
<iframe id="myIframe" width="220%" height="850px" src="http://103.241.181.36:8080/ERPTestBirt/frameset?__report=overdueL2.rptdesign&customer=<%=Transp1%>&Date1=<%=fromdate456%>&Date2=<%=fromdate123%>&Date3=<%=fromdate789%>&Date4=<%=fromdate123000%>&__showtitle=false";> 
</iframe>
</div>
	<%-- <table border="0" width="800px" bgcolor="#E6E6E6" align="center">
<%
