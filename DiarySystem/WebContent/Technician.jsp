...
<iframe id="myIframe" width="220%" height="850px" src="http://103.241.181.36:8080/ERPTestBirt/frameset?__report=detailoverduerreport.rptdesign&Date1=<%=dt%>&Date2=<%=dt1%>&Date3=<%=datex1%>&Date4=<%=datex2%>&__showtitle=false";> 
</iframe>
</div>
	<%-- <table border="0" width="800px" bgcolor="#E6E6E6" align="center">
<%
