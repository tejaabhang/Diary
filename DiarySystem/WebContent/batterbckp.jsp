...
%>
	<table border="0" width="750px" bgcolor="#E6E6E6" align="center">
		<tr bgcolor="#BDBDBD">
			<td align="center">
				...
				<div align="right"><a href="battrbckpexcel.jsp"> <img src="images/excel.jpg" width="15px" height="15px" border="0"/> </a> </div>
			</td>
		</tr>
	</table>
	<br></br>
	...
	<td ><div align="left"><%=Instruction%></div></td>
	...
	<td width="100px" ><div align="left"><%=vehregno%>
	</div>
	<br/>	
...
<%
	...
	<td ><div align="left"><%=transp %></div></td>
...
%>
	<td ><div align="right"><%= new SimpleDateFormat("dd-MMM-yyyy").format(rsbt.getDate("TheDate"))%> <%=rsbt.getString("TheTime")%></div></td>

	<td><a href="# " onclick="window.open('shownewmap.jsp?lat=<%=rsbt.getDouble("LatitudePosition") %>&long=<%=rsbt.getDouble("LongitudePosition")%>' ,'m','width=500,height=500'); popWin.focus(); return false"><b> <font color ="blue" ><%=loc%> </font> </b> </a> <font color="red"> <%=msg %> </font></td>  
<% 
		}else{
			%>
	...
	%></td>
	<td ><div align="left"><%=rsJRMVehicles.getString("InstalledPlace")%> <font color="red"> In Active
			<%
			msg="In Active";
...
<%	}
	...
	//--------------------------------------------------------	
			...
			if(availdate.equals(""))
			{
				...
				<td ><div align="left"><%=availdate %></div> </td>
				<% 
			}
	...
	<td ><div align="left"><%=peripherals %></div></td>
	<%
	if(typevalue.equals("transporter")){
	...
	%>
	<td ><div align="left"><%=simcomp %></div></td>
	<%
	if(typevalue.equals("transporter")){
...
%>
	...
	<td ><div align="left"><%=spcmmnt %></td>
		...
		%>
		<td ><div align="right"><%=Entrydt %></div></td>
		<%} %>
		<td ><div align="left"><%=Enteredby %></div></td>
		<td ><div align="right"><%=b%></div></td>
	<td ><div align="right"><%=stmin%></div></td>
	<td ><div align="left"><%=CodeVersion%></div></td>
		<td ><div align="right"><%=WMSN%></div></td>
	...
	%>
	<td ><div align="right"><%=psno %></div></td>
	<td ><div align="right"><%=pcbno %></div></td>
	<td ><div align="right"><%=boxno %></div></td>
	<td ><div align="right"><%=batteryno %></div></td>
