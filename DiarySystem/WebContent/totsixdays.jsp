<%-- 
    Document   : Total Six Days
    Created on : DJan 8, 2010,
    Author     : Ayaz A.
    Discroption: This page shows Total vehicle having Six Days Delay Data
    last updated : 
    Modified by:
--%>
...
<tr><td align="center" colspan="2"><center><font color="black" size="3">List of All Vehicles Showing 6 Days Data Delay.</font></center></td></tr>
<tr><td colspan="" bgcolor="">  
					<div align="right">  <a href="totsixdaysexcel.jsp?"> <img src="images/excel.jpg" width="15px" height="15px" border="0"/> </a> </div> </td>	
</tr>
</table>
...
try
{
	...
	sql="select a.*,b.UnitID,b.OwnerName,b.installeddate from t_onlinedata a, t_vehicledetails b where a.TheDate = '"+sdays+"' and a.VehicleCode= b.VehicleCode and b.status ='-' and a.Location not like 'No GPS %' order by a.TheDate Desc";
//out.print(sql);
