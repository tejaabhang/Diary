...
try
{
	...
	<form name="form1" id="form1" action="" method="post">
				...
				<td>
					<div align="right">  <a href="csolved1excel.jsp?thename=<%=thename %>&cust=<%=cust %>&fromdate=<%=fromdate %>&todate=<%=todate %>"> <img src="images/excel.jpg" width="15px" height="15px" border="0"/> </a> </div> </td>	
