...
<title>Exception Details of RA Count</title>
...
{  
          ...
          document.ExceptionSummaryRACount.action ="excel.jsp";
          document.forms["ExceptionSummaryRACount"].submit();
}
</script>
</head>
	...
	<tr>
		<td>
			<table border="0" width="100%">
				<tr><td align="center"><font color="black" size="3">Exception Details of RA Count</font></td></tr>
			</table>
		</td>
	</tr>
</table>
...
<form id="ExceptionSummaryRACount" name="ExceptionSummaryRACount" action="" method="post">
	
		<%
		 String  exportFileName="exception_summary_count_RA.xls";
		%>
...
<div style="width:100%;" align="center" id="table1" >
	...
	int count =0;
	String q="";
			sql ="select * from db_gps.t_exceptiondetails where TheDate BETWEEN '"+fDate+"' and '"+tDate+"' and VehID = '"+vehID+"' and ViolationType = 'RAcount' order by SrNo";
