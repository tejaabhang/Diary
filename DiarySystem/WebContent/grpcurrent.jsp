...
<tr>
	...
	<a href="excelgrpcurrent.jsp?transporter=<%=group%>"> <img src="images/excel.jpg" width="15px" height="15px" border="0"/> </a> </div> </td>	
</tr>
</table>
		...
		while(rst.next())
			{
				...
				sql1="select * from t_onlinedata a,t_vehicledetails b where a.VehicleRegNo = '"+vehicleno+"' and a.TheDate = '"+today+"' and b.VehicleRegNumber = '"+vehicleno+"' and b.status not in('Deleted','Removed', 'DeActivated') order by a.TheDate Desc";
