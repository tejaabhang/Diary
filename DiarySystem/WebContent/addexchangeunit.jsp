...
if( (chk1!=true || chk1=="undefined") && (chk2!=true || chk2=="undefined")  ){
    ...
    var veh=document.unitaddform.vehno.value;
     ...
     if(vdt.length=="")
     {
      ...
      if(!invalid3.test(mobno))
	  {
	  alert("Please Enter Numeric Value only for Mobile No.");
	  return false;
	 }
      
      if((mobno.trim().length < 10)  || (mobno.trim().length >15))
		 {
...
return false;
   ...
   //alert("category>>>>>"+vehcat)
       ...
       if(vehcat=="Select")
      {
       ...
       var soldout12= document.unitaddform.soldout.value; 
       // alert(hour) 
        if(soldout12=="Select")
        {
...
if(cc==""||cc==null){
	...
	var drivarname=document.unitaddform.drivername.value;  
  	...
  	var invalid=/^[A-Za-z .]+$/;
    	 ...
    	 if(!invalid.test(drivarname))
    		 {
    		 alert("Please Enter Valid Character's Only for Driver Name");
  			return false;
    		 }
    	 var invalid1=/^[0-9]+$/;
    	if(drivermobno.trim()==""){
 		...
 		return false;
 	   		...
 	   		if(!invalid1.test(drivermobno))
				{
					alert("Please  Enter Numeric Value Only for Driver Mobile No ");
					return false;
				}
 			if((drivermobno.trim().length < 10)  || (drivermobno.trim().length >15))
 			   {
...
try
{
	...
	String oldvehno=request.getParameter("oldvehno");

	%>
	<input type="hidden" name="oldveh" id="oldveh" value=<%=request.getParameter("oldvehno")%>></input>
	<% 
	
	System.out.println("Old Veh :- "+oldvehno);
%>
<form name="unitaddform" method="post" action="insrtaddremoveunit.jsp" onsubmit="return validate();">
...
<%}%>
 	...
 	<table border="0" width="950px" bgcolor="#E6E6E6" align="center">
		<tr>
	...
	<%
       String customerCode="";
	try{
	String sqlCustomerCode="select distinct(ERPCode) from db_gps.t_transporter where TypeValue='"+transporter+"' ";
	ResultSet rsCustomerCode=sterp1.executeQuery(sqlCustomerCode);
	System.out.println("ERP Code :- "+sqlCustomerCode);
	rsCustomerCode.next();
	...
	int i=1;
        try{
            ...
            String year11="SELECT  DATE (CURDATE() - INTERVAL 2 DAY) ";
	...
	System.out.println("ERP Invoice :- "+sqlerp1);
	...
	<table border="0" width="950px" bgcolor="#E6E6E6" align="center">
	<tr bgcolor="#BDBDBD">
			<td><font color="red" size="2">*</font><font color="black" ><b>Transporter :</b></font></td>
			<td>
<%if(transporter!=null){%>
...
%>
		...
		<% String unitid=request.getParameter("unitid");
			...
			%>
		<tr bgcolor="#BDBDBD">
			<td><font color="red" size="2">*</font><font color="black" ><b>Vehicle Reg. No.: </b></font></td>
			<td><input type="text" name="vehno" class="formElement" value="<%=Vehno %>" readonly="readonly" /> </td>
			<td>
			<font color="red" size="2">*</font>	<font color="black" ><b>Unit Id:</b></font>
			</td>
			<td>
			
				<input type="text" name="uid" size="10" class="formElement" value="<%=unitid%>" readonly="readonly" />
			</td>
		</tr>
		<tr bgcolor="#BDBDBD">
			<td>
			<font color="red" size="2">*</font>	<font color="black" ><b>Mobile No.: </b></font>
			</td>=
<!-- When mobno textbox will be clicked, AJAXFunc() in javascript will be called which again calls Ajaxunitadd.jsp and MobNo and SIM No wil be put automatically in their respective fields.  -->
			<td>
				<input type="text" name="mobno" size="13" class="formElement" value=""/> 
			</td>
			<td>
			<font color="red" size="2">*</font>	<font color="black" ><b>Sim No.:</b></font>
			</td>
			<td>
		...
		<tr bgcolor="#BDBDBD">
			<td>
				<font color="red" size="2">*</font><font color="black" ><b>Unit Type:</b></font>
			</td>
			<td>
				<input type="text" name="InstType" size="13" class="formElement" readonly> 
			</td>
			<td>
				<font color="red" size="2">*</font><font color="black" ><b>OS Duration In Sec:</b></font>
			</td>
			<td>
		...
		<tr bgcolor="#BDBDBD">
			<td>
				<font color="black" > <font color="red" size="2">*</font><b>Installation Date:</b></font>
			</td>
			<td>
			...
			<td>
			<font color="red" size="2">*</font>	<font color="black" ><b>Installation Time:</b></font>
			</td>
			<td>       
		...
		<tr bgcolor="#BDBDBD">
			<td>
			<font color="red" size="2">*</font>	<font color="black" ><b>Installed at: </b></font>
			</td>
			<td>
...
%>
	...
	<!--		<select name="typeunit" class="formElement" onChange="voicecall(this);">
		...
		<tr bgcolor="#BDBDBD">
			<td>  <font color="red" size="2">*</font> <font color="black" ><b>Installed By: </b></font></td>
...
<%  } %>
		...
		<tr bgcolor="#BDBDBD">
			<td><font color="black" ><b>Vehicle Desc</b></font></td>
 			...
 			<td> <font color="red" size="2">*</font><font color="black" ><b>Soldout/Demo</b></font></td>
			<td>
		...
		<tr bgcolor="#BDBDBD">
			<td colspan="2" align="center"> <font color="red" size="2">*</font><font color="black" ><b>  New Unit Run on: </B> </font> </td>
	...
	<tr bgcolor="#BDBDBD">
			<td><font color="red" size="2">*</font> <font color="black" ><b>Vehicle Category: </b></font></td>
...
<!-- Below 3 fileds are not mandatory to fill -->
		<tr bgcolor="#BDBDBD">
		  <td> <font color="red" size="2">*</font><font color="black" > <b> Driver Name: </b> </font> </td>
		...
		<tr bgcolor="#BDBDBD">
		  <td colspan="4" align="center"> <font color="red" size="2">*</font><font color="black" > <b> Driver Mob. No.: </b> </font> &nbsp;&nbsp;
				<input type="text" name="drivermob" class="formElement" /> </td>
		</tr>
		<tr bgcolor="#BDBDBD">
		  <td colspan="4" align="center"><font color="red" size="2">*</font> <font color="black" > <b> To(enter comma seperated mail id):</b> </font> &nbsp;&nbsp;
				<!-- <textarea rows="1" cols="70" name="to"  class="formElement"></textarea> --> 
				<input type="email" name="to" class="formElement"  multiple/></input>
				
				</td>
		</tr>
		<tr bgcolor="#BDBDBD">
		  <td colspan="4" align="center"><font color="red" size="2">*</font> <font color="black" > <b> CC(enter comma seperated mail id):</b> </font> &nbsp;&nbsp;
				<!-- <textarea rows="1" cols="70" name="cc"  class="formElement"></textarea> --> 
				<input type="email" name="cc" class="formElement" multiple/>
...
%>
		<tr bgcolor="#BDBDBD">
		<td colspan="2"><font color="red" size="2">*</font> <font color="maroon" ><b>Why you are using this option?</b></font></td>
