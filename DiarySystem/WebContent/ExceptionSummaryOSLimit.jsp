...
<title>Exception Details of OS Limit</title>
...
{  
          ...
          document.ExceptionSummaryOSLimit.action ="excel.jsp";
          document.forms["ExceptionSummaryOSLimit"].submit();
}
function registercom(cnt,fdate,tdate){
	try{
 		 //alert(">"+cnt+">"+fdate+">"+tdate+">");
	...
	<tr>
		<td>
			<table border="0" width="100%">
				<tr><td align="center"><font color="black" size="3">Exception Details of OS</font></td></tr>
			</table>
		</td>
	</tr>
</table>
...
<form id="ExceptionSummaryOSLimit" name="ExceptionSummaryOSLimit" action="" method="post">
	
		<%
		 String  exportFileName="exception_summary_limit_OS.xls";
		%>
...
<div style="width:100%;" align="center" id="table1" >
	...
	int count =0;
	String q="";
			sql ="select * from db_gps.t_exceptiondetails where TheDate BETWEEN '"+fDate+"' and '"+tDate+"' and VehID = '"+vehID+"' and ViolationType = 'OSlimit' order by SrNo";
