...
<table border="0" width="750px">
<tr>
	<td colspan="10" align="center"> <font color="maroon" size="3"> <B> VEHICLE LIST OF <%=group %> Which Are Removed.</B> </font> 
</td>
</tr>
</table>
		...
		while(rst.next())
			{
				...
				sql1="select * from t_onlinedata a,t_vehicledetails b where a.VehicleRegNo = '"+vehicleno+"' and b.VehicleRegNumber = '"+vehicleno+"' and b.status = 'Removed' order by a.TheDate Desc";
