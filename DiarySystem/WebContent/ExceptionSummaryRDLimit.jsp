...
<title>Exception Details of RD Limit</title>
...
{  
          ...
          document.ExceptionSummaryRDLimit.action ="excel.jsp";
          document.forms["ExceptionSummaryRDLimit"].submit();
}
	...
	<tr>
		<td>
			<table border="0" width="100%">
				<tr><td align="center"><font color="black" size="3">Exception Details of RD</font></td></tr>
			</table>
		</td>
	</tr>
</table>
...
<form id="ExceptionSummaryRDLimit" name="ExceptionSummaryRDLimit" action="" method="post">
	
		<%
		 String  exportFileName="exception_summary_limit_RD.xls";
		%>
...
<div style="width:100%;" align="center" id="table1" >
	...
	int count =0;
	String q="";
			sql ="select * from db_gps.t_exceptiondetails where TheDate BETWEEN '"+fDate+"' and '"+tDate+"' and VehID = '"+vehID+"' and ViolationType = 'RDlimit' order by SrNo";
