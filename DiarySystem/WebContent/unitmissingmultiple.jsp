  ...
  <div id="outer">
	...
	<div id="gbox1">
            ...
            <div id="gbox-bg1">
              <div id="gbox-grd1">
<!--- code start here ------>
  <form name="removeunitform" method="get" action="multipledeactivationInsert.jsp" onsubmit="return validate();">
...
<tr>
			<td colspan="12"><div align="center"><font color="brown" size="3"> <B> Unit Missing </B> </font></div></td>
		</tr>
<tr>
   <td> <div align="center">
...
for(int k=0;k<cntr;k++)
{
 ...
 %>
		<tr>
			...
			<td> <input type="text" name="owner<%=k%>" class="formElement" size="14" value="<%=transporter %>" /> </td>
		
			<th>  <font color="maroon"> Vehicle Reg. No.:  </font>
			</th>
			<td> <input type="text" name="vehreg<%=k%>" class="formElement" size="14" value="<%=vehno[k]%>" /> </td>
		
			<th>  <font color="maroon"> Unit Id:  </font> </th>
			<td> <input type="text" name="unitid<%=k%>" class="formElement" size="8" value="<%=unitid[k] %>" /> </td>
