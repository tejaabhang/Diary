...
<table border="0" width="750px" align="center">
	<tr>
		<td> <div align="center" width="750px"><font color="Brown" size="2">Total Calls To Transporters </font></div>
		</td>
	</tr>
</table>
<table border="1" width="750px" class="sortable">
   ...
   // {
    ...
    while(s.hasMoreTokens())
		...
		sql="select * from t_callinformation where TheDate='"+today+"' and Transporter='"+transporter+"' and CallerType='transporter'";
		//out.print(sql);
