...
<table border="0" width="750px">
<tr>
	<td colspan="10" align="center"> <font color="maroon" size="3"> <B> VEHICLE LIST OF <%=group %> Which Are Temporarily Removed.</B> </font> 
</td>
</tr>
</table>
...
<tr>
	...
	<a href="excelgrpremoved.jsp?transporter=<%=group%>"> <img src="images/excel.jpg" width="15px" height="15px" border="0"/> </a> </div> </td>	
</tr>
</table>
		...
		while(rst.next())
			{
				...
				sql1="select * from t_onlinedata a,t_vehicledetails b where a.VehicleRegNo = '"+vehicleno+"' and b.VehicleRegNumber = '"+vehicleno+"' and b.status = 'Removed'  order by TheDate Desc" ;
...
//*****************************For Removed Unit**********************************
		...
		String deactdate="";
		String deactunit="";
		sql5="select * from t_unitreplacement where VehRegNo='"+vehicleno+"' and 103.241.181.36='Rem' order by EntDate desc";
