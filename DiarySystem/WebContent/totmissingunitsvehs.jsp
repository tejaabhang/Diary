...
<table border="0" width="750px" align="center">
	<tr>
		<td> <div align="center" width="750px"><font color="Brown" size="2">Total Missing Units </font></div>
		</td>
	</tr>
</table>
<table border="1" width="750px">
   ...
   // {
    ...
    while(s.hasMoreTokens())
	{
		...
		sql1="select * from t_unitmissing where Owner='"+transporter+"' and Status='Missing' order by EntDateTime desc";
	...
	<%
    	...
    	<tr>
	<td><%=i%></td>
	<td><a href="javascript:toggleDetails(<%=i%>,true);" title="Click Here"><%=rs1.getString("VehNo")%>
	</a>
	<br/>	
	...
	<td><%
	sql="select * from t_startedjourney where VehRegNo='"+rs1.getString("VehNo")+"' and StartDate >'"+olddate+"'";
