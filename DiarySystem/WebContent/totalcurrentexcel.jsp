...
String filename="Total_Current_Vehicles.xls";
...
<tr><td align="center" colspan="2"><center><font color="black" size="3">List of All Vehicles Showing ToDays Data.</font></center></td></tr>
<tr><td colspan="" bgcolor="">  
					<div align="right">  <a href="totalcurrentexcel.jsp?"> <img src="images/excel.jpg" width="15px" height="15px" border="0"/> </a> </div> </td>	
</tr>
...
try
{
	 ...
	 if(userrole2.equalsIgnoreCase("supertech")){
		...
		sql="select a.*,b.UnitID,b.OwnerName,b.installeddate from t_onlinedata a, t_vehicledetails b where a.TheDate ='"+tdydate+"'and a.VehicleCode= b.VehicleCode and b.status ='-' and a.Location not like 'No GPS %' order by a.TheDate Desc";
	//out.print(sql);
