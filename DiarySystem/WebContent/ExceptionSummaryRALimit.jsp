...
<title>Exception Details of RA Limit</title>
...
{  
          ...
          document.ExceptionSummaryRALimit.action ="excel.jsp";
          document.forms["ExceptionSummaryRALimit"].submit();
}
function registercom(cnt,fdate,tdate){
	try{
 		...
 		//alert(">violationValue2>"+violationValue2+">>");
 	 	...
 	 	window.location.href = "ExceptionRegisterComplaintDiary.jsp?TheDate='"+theDate+"'&VehCode='"+vehCode+"'&VehRegNo='"+vehRegNo+"'&Trans='"+trans+"'&ViolationType='"+violationType+"'&ViolationDate='"+violationDate+"'&ViolationTime='"+violationTime+"'&ViolationValue='"+violationValue+"'&ViolationValue2='"+violationValue2+"'&fDate='"+fdate+"'&tDate='"+tdate+"' ";
		//alert(">>>hihih");
 	 }catch(e)
 	 {
 		 alert(e);
	...
	<tr>
		<td>
			<table border="0" width="100%">
				<tr><td align="center"><font color="black" size="3">Exception Details of RA</font></td></tr>
			</table>
		</td>
	</tr>
</table>
...
<form id="ExceptionSummaryRALimit" name="ExceptionSummaryRALimit" action="" method="post">
	
		<%
		 String  exportFileName="exception_summary_limit_RA.xls";
		%>
...
<div style="width:100%;" align="center" id="table1" >
	...
	int count =0;
	String q="";
			sql ="select * from db_gps.t_exceptiondetails where TheDate BETWEEN '"+fDate+"' and TheDate <= '"+tDate+"' and VehID = '"+vehID+"' and ViolationType = 'RAlimit' order by SrNo";
			...
			while(rs.next())
			{
				...
				%>
					...
					<td bgcolor="#f5f5f5" align="right" id = "vioval2<%=count %>"><%= ViolationValue2%></td>
