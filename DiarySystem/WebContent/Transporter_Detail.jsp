...
<head>
	...
	{	
		...
		var transporter  = document.form1.hiddenrep.value;
		
		document.form1.action ="Transporter_Detail.jsp?transporter="+techname+"&date1="+dt1+"&date2="+dt2;
...
String todate = request.getParameter("date2");String myfromdate = new SimpleDateFormat("yyyy-MM-dd 00:00:00").format(new SimpleDateFormat("yyyy-MM-dd").parse(fromdate));
...
%>
			...
			<form name="form1" id="form1" action="" method="post">
				...
				<tr>
				<input type="hidden" id="hiddenrep" name="hiddenrep" size="13" class="formElement" value="<%=transporter%>" readonly="readonly"/>
...
try
{
	...
	////System.out.println("i should be here after submit.");
