	...
	if(flag.equals("true"))
 	{
   		...
   		response.sendRedirect("PendingUnits.jsp?nounitselected=true&holdername="+holdername);
   		return;
 	}
	else
 	{
		...
		for(int i=0; i<cntrint; i++) 
     		{
				...
				sql1="update t_unitmaster set TransDate='"+tdydte+"', HoldBy='"+holdbyinsrt+"', CommentForTransf='"+comment+"', FaultyUnit='"+unittyp+"' where UnitID='"+unid[i]+"' ";
		...
		response.sendRedirect("PendingUnits.jsp?updated=yes&holdername="+holdername);
		return;
	}
