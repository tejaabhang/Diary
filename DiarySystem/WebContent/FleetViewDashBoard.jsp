...

{
	...
	document.getElementById('myIframe').src="http://173.234.153.82:8181/birttest/frameset?__report=FleetViewComp.rptdesign&__showtitle=false";	
...

	{
		...
		document.getElementById('myIframe').src="http://173.234.153.82:8181/NewBirtTestFleetView/frameset?__report=FleetViewComp.rptdesign&__showtitle=false";	
		document.getElementById("reportData").style.display= "";
		return true;
...
<font size="2">
	...
	<iframe align="middle" id="myIframe" width='92%' height='650px' src="">
	</iframe>
			</div>
		<%
}
