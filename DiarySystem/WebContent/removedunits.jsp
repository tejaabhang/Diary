...
<center><font color="black" size="2">Removed Vehicle List of <%=transporter %> .</font></center>
</td></tr>
...
try
{
	...
	Svehlist=Svehlist+")";
	*/
	sql="select * from t_vehicledetails where ownername='"+transporter+"' and status ='Removed'"; 
	...
	<td><%
		String remdate="";
		sql2="select * from t_unitreplacement where VehRegNo='"+rst1.getString("VehicleRegNumber")+"' or VehCode='"+rst1.getString("VehicleCode")+"' and 103.241.181.36='Rem' order by EntDate desc";
