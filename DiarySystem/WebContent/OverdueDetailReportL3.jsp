...
<%!Connection conn, conn1;
	...
	String data="",fromdate="",transporter="",Svehlist="",today="",typeunit="";
      ...
      function validate()
 			...
 			function tempremoval()
 			{
 				...
 				function birt(){
 					...
 					document.getElementById("myIframe").src="http://103.241.181.36:8080/ERPTestBirt/frameset?__report=oldsummaryreport.rptdesign&Date1="+formattedDate1+"&Date2="+formattedDate2+"&Date3="+date1+"&Date4="+date2+"&__showtitle=false;";
 					
 					<%-- <iframe id="myIframe" width="220%" height="850px" src="http://103.241.181.36:8080/ERPTestBirt/frameset?__report=oldsummaryreport.rptdesign&Date1=<%=datex1%>&Date2=<%=datex2%>&__showtitle=false";> 
 					</iframe> --%>
...
<%-- <table  width="750px">
	...
	<%!String datex1, datex2, data1, data2,dt,dt1,Transp1,fromdate123,fromdate456,fromdate789,fromdate123000,contactname;
	...
	fromdate456=request.getParameter("Fromdate");
	fromdate123=request.getParameter("Todate");
	fromdate789=request.getParameter("fromdate1");
	fromdate123000=request.getParameter("todate1");
	Transp1=request.getParameter("customer");
...
<iframe id="myIframe" width="220%" height="850px" src="http://103.241.181.36:8080/ERPTestBirt/frameset?__report=OverdueL3Report.rptdesign&customer=<%=Transp1%>&Date1=<%=fromdate456%>&Date2=<%=fromdate123%>&Date3=<%=fromdate789%>&Date4=<%=fromdate123000%>&contact=<%=contactname%>&__showtitle=false";> 
</iframe>
</div>
	<%-- <table border="0" width="800px" bgcolor="#E6E6E6" align="center">
<%
	...
	if(transporter.equalsIgnoreCase("Topsline") || transporter.equalsIgnoreCase("HPCL") || transporter.equalsIgnoreCase("Ujjain") )
	{
		...
		if(rsttuh.next())
		{
			...
			if(battr.next())
			{
				...
				battrystatustime =battr.getString("bdatetime");	f
...
<%-- <iframe id="myIframe" width="100%" height="850px" src="http://myfleetview.com:8080/birt/frameset?__report=JRM_report.rptdesign&userid=<%=UserID%>&__showtitle=false"> --%> 
<%-- <iframe id="myIframe" width="220%" height="850px" src="http://103.241.181.36:8080/ERPTestBirt/frameset?__report=oldsummaryreport.rptdesign&Date1=<%=dt%>&Date2=<%=dt1%>&Date3=<%=datex1%>&__showtitle=false";>  --%>
