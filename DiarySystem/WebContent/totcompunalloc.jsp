...
<table border="0" width="750px" align="center">
	<tr>
		<td> <div align="center" width="750px"><font color="Brown" size="2">Total Unallocated Complaints </font></div>
		</td>
	</tr>
</table>
   ...
   // {
    ...
    while(s.hasMoreTokens())
		...
		if(transporter.equals("a"))
		{
    	 ...
    	 sql="select * from t_complaints1 where Customer='"+transporter+"' and Status in ('UnAllocated')";
    	 //out.print(sql);
