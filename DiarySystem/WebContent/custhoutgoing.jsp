...
try
{
	...
	<%
		sql="select * from db_CustomerComplaints.t_callinformation where Reciever in(select distinct(OwnerName)as OwnerName from db_gps.t_vehicledetails where status='-' order by OwnerName Asc) and TheDate >='"+fromdate+"' and TheDate <='"+todate+"' and CallType='OutGoing'";
