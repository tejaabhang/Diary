...
<table border="0" width="750px">
<tr>
	<td colspan="10" align="center"> <font color="maroon" size="3"> <B> VEHICLE LIST OF <%=group %> </B> </font> 
</td>
</tr>
</table>
...
<tr>
	...
	<a href="excelgrpfullfleet.jsp?transporter=<%=group%>"> <img src="images/excel.jpg" width="15px" height="15px" border="0"/> </a> </div> </td>	
</tr>
</table>
...
String psno="",pcbno="",boxno="",batteryno="";
		...
		sql="select Distinct(a.transporter),c.TheTime,c.TheDate,b.UnitID,b.OwnerName,b.InstalledDate from t_group a, t_vehicledetails b left outer join db_gps.t_onlinedata c on b.VehicleCode=c.VehicleCode where a.GPName = '"+group+"' and a.transporter = b.VehicleRegNumber and b.status <> 'del' order by c.TheDate desc,c.TheTime desc";
		...
		while(rst.next())
			{
				...
				sql1="select * from t_onlinedata where VehicleRegNo = '"+vehicleno+"' order by TheDate desc, TheTime desc";
				...
				if(rst2.next())
				{
					...
					psno = rst2.getString("PSNo");
					pcbno = rst2.getString("PCBNo");
					boxno = rst2.getString("BoxNo");
					batteryno = rst2.getString("BatteryNo");
				}
