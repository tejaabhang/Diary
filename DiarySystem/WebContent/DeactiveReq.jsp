...
{	
	...
	{%>
		...
		<td align="center"> <font color="red"> <b>
			Successfully Deactivated  </b></font>
		</td> </tr> </table>
<%
	}
%>
	...
	<table border="0" width="750px" bgcolor="#77D7D4" align="center">
		<tr>
			<td colspan="4"><div align="center"><font color="black" size="3"> <B> De-Activation Request </B> </font></div></td>
		</tr>
		</table>
		<br></br>
...
<%
	...
	else
	{
		...
		if(rs44.next()){
			...
			String status=rs44.getString("103.241.181.36");
			//System.out.println(status);
			if(status.equalsIgnoreCase("DeActive")){
				%>
				<tr> <td colspan="4"> 
						<div align="center"> <font color="maroon" size="3">Unit is already Deactivated.No need of Deactivation</font></div> 
 			</td>
		</tr>
				...
				%>
				<tr> <td colspan="4"> 
						<div align="center"> <font color="maroon" size="3">Unit is already temporary removed.No need of Deactivation</font></div> 
 			</td>
		</tr>
...
%>
		...
		<tr>
			<td>  De-Activation Request as per:  </td>
			<td> <input type="radio" name="deactasper" value="Customer">Customer
					<input type="radio" name="deactasper" value="Transworld" checked>Transworld
					<input type="radio" name="deactasper" value="Barred" >Barred
			</td>
		</tr>
		<tr> <td colspan="2"> <div align="center"> <input type="submit" name="submit" value="DeActivate" class="formElement"> </input> </div> </td> 
		</tr>
