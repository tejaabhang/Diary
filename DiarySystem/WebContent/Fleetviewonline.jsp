...

{
	...
	document.getElementById('myIframe').src="http://173.234.153.82:8181/birttest/frameset?__report=OnlineVehicle.rptdesign&__showtitle=false";	
...

	{
		...
		document.getElementById('myIframe').src="http://173.234.153.82:8181/NewBirtTestFleetView/frameset?__report=OnlineVehicle.rptdesign&__showtitle=false";	
		document.getElementById("reportData").style.display= "";
		return true;
