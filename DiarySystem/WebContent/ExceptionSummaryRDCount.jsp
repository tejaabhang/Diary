...
<title>Exception Details of RD Count</title>
...
{  
          ...
          document.ExceptionSummaryRDCount.action ="excel.jsp";
          document.forms["ExceptionSummaryRDCount"].submit();
}
</script>
</head>
	...
	<tr>
		<td>
			<table border="0" width="100%">
				<tr><td align="center"><font color="black" size="3">Exception Details of RD Count</font></td></tr>
			</table>
		</td>
	</tr>
</table>
...
<form id="ExceptionSummaryRDCount" name="ExceptionSummaryRDCount" action="" method="post">
	
		<%
		 String  exportFileName="exception_summary_count_RD.xls";
		%>
...
<div style="width:100%;" align="center" id="table1" >
	...
	int count =0;
	String q="";
			sql ="select * from db_gps.t_exceptiondetails where TheDate BETWEEN '"+fDate+"' and '"+tDate+"' and VehID = '"+vehID+"' and ViolationType = 'RDcount' order by SrNo";
			...
			while(rs.next())
			{
				...
				%>
					...
					<td bgcolor="#f5f5f5" align="right"><%= ViolationValue1%></td>
