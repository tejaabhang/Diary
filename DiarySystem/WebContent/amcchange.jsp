...
try{
	...
	for(int i=0; i<cntr; i++)
	{
		...
		if(rs1.next())
		{
			sql2="insert into t_amchistory (Transporter, VehCode, VehNo, OldDate, NewDate, EntBy, WarrantyTill) values ('"+transporter+"', '"+vehcode+"', '"+rs1.getString("VehicleRegNumber")+"','"+rs1.getString("InstalledDate")+"','"+newamcdate+"','"+user+"','"+amcdatetill+"')";
			...
			//sql3="update t_vehicledetails set InstalledDate='"+newamcdate+"' where VehicleCode='"+vehcode+"'";
