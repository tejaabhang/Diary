<%-- 
    Document   : Six Days
    Created on : 8 JAN 2009
    Author     : Ayaz A.
    Discroption: this page show the vehicles having 6 Days delay Data
    last updated : 
    Modified by: 
...
Statement st, st1,st11, st2, st3, st01,stwar1,stwar2,stwar3,stwar4;
...
<tr><td align="center" colspan="2"><center><font color="black" size="3">Vehicle List of <%=transporter %> Showing 6 Data Delay.</font></center></td></tr>
...
try
{
	...
	Svehlist=Svehlist+")"; 
	sql="select * from t_onlinedataotherservers where Transporter='"+transporter+"' and TheDate = '"+sdays+"' and Location not like 'No GPS %' and VehicleCode in "+Svehlist+" order by TheDate,TheTime Desc";
//out.println(sql);
	ResultSet rst1=st11.executeQuery(sql);
	int i=1;
	while(rst1.next())
	{
	...
	Svehlist=Svehlist+")"; 
	sql="select a.*,b.UnitID,b.installeddate,b.VehicleCode from t_onlinedata a, t_vehicledetails b where a.Transporter='"+transporter+"' and a.TheDate = '"+sdays+"' and a.VehicleCode=b.VehicleCode and b.status ='-' and a.Location not like 'No GPS %' and a.VehicleCode in "+Svehlist+" order by TheDate Desc";
