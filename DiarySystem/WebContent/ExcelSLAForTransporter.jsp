...
<td>SLA Required</td>
	...
	{	
	    ...
	    String sql="SELECT * FROM db_gps.t_billingdetails WHERE month1 = '"+fromdate+"' AND Transporter like '%"+transporter+"%'";
	   ...
	   while(rst.next())
		   ...
		   String Customer=rst.getString("Transporter");
	   		...
	   		String Maintenance=rst.getString("TotalYesStarStar");
