...
function validate1()
{
	...
	var oldunit=document.getElementById("techname").value;
	var reason=document.getElementById("reason").value;
	var exchange=document.getElementById("vehno").value;
	
	if(oldunit=="Select")
		{
		alert("Please Select Old unit With");
        return false;		
		}
	...
	if(reason=="exchange")
	{
		if(exchange.trim()=="")
			{
			alert("Please Enter Veh no for Exchange");
			return false;
...
function AjaxvehValidation()
{
	var vehregno=document.getElementById("vehno").value;
    ...
    try{
        ...
        var queryString = "?newvehregno="+vehregno;
	ajaxRequest.open("GET", "AjaxVehicleValidation.jsp"+queryString, true);
	ajaxRequest.send(null); 
...
<body> <!-- 
<form name="removeunitform" method="post" action="vehexchangenxt.jsp"  onsubmit="return validate();"> -->
  ...
  <div id="outer">
	...
	<div id="gbox1">
            ...
            <div id="gbox-bg1">
              <div id="gbox-grd1">
<!--- code start here ------>
      <form id="removeunitform" method="get" action="vehexchangenxt.jsp"  onsubmit="return validate1();">	
...
%>
		<tr>
			<td><font color="red" size="2">*</font> <font color="maroon"> Old Unit with: </font> </td>
			<td> <select name="techname"  id="techname"  class="formElement"> 
				<option value="Select">Select</option>
<%
				while(rs2.next())
				{ %>
...
%>				
		...
		<tr>
	<td><font color="red" size="2">*</font> <font color="maroon"> Reason: </font> </td>
	<td>
	<select name="reason" id="reason" onchange="reason1(this.value);" class="formElement">
	<option value="Select">Select</option>
		...
		<tr id="used" style="display: none">
			<td>  <font color="maroon"> Vehicle  No.:  </font>
			</td>
			<td>
				<input type="text" name="vehno" id="vehno" class="formElement" value=""  />		
			</td>
		</tr>
