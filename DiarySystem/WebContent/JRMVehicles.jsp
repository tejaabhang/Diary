...
%>
	<table border="0" width="750px" bgcolor="#E6E6E6" align="center">
		<tr bgcolor="#BDBDBD">
			<td align="center">
				...
				<div align="right"><a href="excelJRMVehicleDetails.jsp"> <img src="images/excel.jpg" width="15px" height="15px" border="0"/> </a> </div>
			</td>
		</tr>
	</table>
	<br></br>
	...
	<td width="100px" ><div align="left"><a href="javascript:toggleDetails(<%=i%>,true);" title="Click Here"><b><%=vehregno%></b>
	</a></div>
	<br/>	
...
<!--  <td ><div align="left"><%=rst1.getString("Location")%>  <font color="red"> <%=msg %> </font></div> -->
