...
String filename="No_GPS_Vehicles.xls";
...
<tr><td align="center" colspan="2"><center><font color="black" size="3">List of All Vehicles Showing NO GPS Data.</font></center></td></tr>
...
try
{
	...
	if(userrole2.equalsIgnoreCase("supertech")){
		...
		sql="select a.*,b.UnitID,b.installeddate,b.OwnerName from t_onlinedata a, t_vehicledetails b where a.VehicleCode= b.VehicleCode and b.status not in('Deleted','Removed', 'DeActivated') and a.Location like 'No GPS %' order by a.TheDate Desc";
	//out.print(sql);
		...
		//out.print(rst1.getString("unitid"));
		//totcurrentout.print(unitid);
		...
		<td align="left"><%= new SimpleDateFormat("dd-MMM-yyyy").format(rst1.getDate("TheDate"))%> <%=rst1.getString("TheTime")%></td>
