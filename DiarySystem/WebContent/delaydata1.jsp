<%-- 
    ...
    Modified by: Ayaz A. ON::-08-01-2010
--%>
...
<tr><td align="center" colspan="2"><center><font color="black" size="3">Vehicle List of <%=transporter %> Showing 3 TO 5 Data Delay.</font></center></td></tr>
...
try
{
	...
	Svehlist=Svehlist+")"; 
	sql="select * from t_onlinedataotherservers where Transporter='"+transporter+"' and TheDate < '"+today+"' and TheDate > '"+sdays+"' and Location not like 'No GPS %' and VehicleCode in "+Svehlist+" order by TheDate,TheTime Desc";
	...
	Svehlist=Svehlist+")"; 
	sql="select a.*,b.UnitID,b.installeddate,b.VehicleCode from t_onlinedata a, t_vehicledetails b where a.Transporter='"+transporter+"' and a.TheDate < '"+today+"' and a.TheDate > '"+sdays+"' and a.VehicleCode=b.VehicleCode and b.status ='-' and a.Location not like 'No GPS %' and a.VehicleCode in "+Svehlist+" order by TheDate Desc";
