...
String sql,sql1,username,userrole,today,olddate,thedate,technician,tno,vehregno,comdate,availdate,instdate,rep;
  ...
  <div id="outer">
	...
	<div id="gbox1">
            ...
            <div id="gbox-bg1">
              <div id="gbox-grd1">
<!--- code start here ------>
<form name="techsolf" method="get" action="actioninsert2.jsp" OnSubmit="return Validate();">
<%
