...
<title>Exception Details of DS</title>
...
{  
          ...
          document.ExceptionSummaryDSCount.action ="excel.jsp";
          document.forms["ExceptionSummaryDSCount"].submit();
}
	...
	<tr>
		<td>
			<table border="0" width="100%">
				<tr><td align="center"><font color="black" size="3">Exception Details of CD</font></td></tr>
			</table>
		</td>
	</tr>
</table>
...
<form id="ExceptionSummaryDSCount" name="ExceptionSummaryDsCount" action="" method="post">
	
		<%
		 String  exportFileName="exception_summary_count_DS.xls";
		%>
...
<div style="width:100%;" align="center" id="table1" >
	...
	int count =0;
	String q="";
			sql ="select * from db_gps.t_exceptiondetails where TheDate BETWEEN '"+fDate+"' and '"+tDate+"' and VehID = '"+vehID+"' and ViolationType = 'Distance' order by SrNo";
