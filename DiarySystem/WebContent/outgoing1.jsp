...
try
{
	...
	<tr><td align="center"><font color="brown" size="2">Outgoing calls to <%=cust%> from <%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(fromdate))%> to <%=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(todate))%> </font></td></tr>	
	<tr><td>
	...
	<%
		sql="select * from t_callinformation where Reciever='"+cust+"' and TheDate >='"+fromdate+"' and TheDate <='"+todate+"' and CallType='OutGoing'";
