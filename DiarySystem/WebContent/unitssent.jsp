  ...
  <div id="outer">
	...
	<div id="gbox1">
            ...
            <div id="gbox-bg1">
              <div id="gbox-grd1">
<!--- code start here ------>
<form name="receivedform" method="get" action="unitsentinsrt.jsp" onSubmit="return validate();">
<%
try
{
...
<table border="0" width="750px" bgcolor="#77D7D4" align="center">
         	<tr>
             	  	<td> <div align="center"> <font color="black" size="3"> <B> Unit Received </B></font></div> </td>
         	</tr>
      </table> 
<br></br>
<%
...
<center>
 ...
 <tr>
       <td><input type="hidden" name="cmment" id="cmment" value="" /> Date :  </td>
       <td> <input type="text" id="calender" name="calender" size="13"  value=<%=sdt%>  readonly/>
            <input type="button" name="trigger" id="trigger" value="On Date"  style="visibility:visible">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Time : &nbsp;&nbsp;<input type="text" name="rtime" size="10" value="<%=tm%>" readonly>
   ...
   <tr>
      <td> Courier Name :  </td>
      <td> <input type="text" name="courier"  onChange="updateClock();"></td>
  </tr>
  <tr>
      <td> Courier Docket No :  </td>
      <td> <input type="text" name="courierdcno" ></td>
  </tr>
  <tr>
	<td>  Tech Name :  </td>
...
<% } %>
   ...
   <tr>
	...
	<td>
	        <input type=radio name="radio2" value="Defective" checked>  <font color="maroon"> Defective </font>
		<input type=radio name="radio2" value="Ok" >  <font color="maroon"> New </font>
		<input type=radio name="radio2" value="Service Unit" >  <font color="maroon"> Service Unit </font>
	</td>
   </tr>	
    <tr>
	<td> Unit ID: </td>
