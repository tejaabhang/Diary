...
String filename="3_to_6_days_Delay_Vehicles.xls";
...
<tr><td align="center" colspan="2"><center><font color="black" size="3">List of All Vehicles Showing 3 To 6 Days Data Delay.</font></center></td></tr>
...
//out.print(sql);
	...
	sql="select a.*,b.UnitID,b.OwnerName,b.installeddate from t_onlinedata a, t_vehicledetails b where a.TheDate < '"+today+"' and a.TheDate > '"+today4+"' and a.VehicleCode= b.VehicleCode and b.status ='-' and a.Location not like 'No GPS %' order by a.TheDate Desc";
//out.print(sql);
	ResultSet rst1=st1.executeQuery(sql);
	int i=1;
	while(rst1.next())
