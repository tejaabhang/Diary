...
<table border="0" width="750px">
<tr>
	<td colspan="10" align="center"> <font color="maroon" size="3"> <B> VEHICLE LIST OF <%=group %> Showing 3 To 5 DAYS Data Delay.</B> </font> 
</td>
</tr>
</table>
...
<tr>
	...
	<a href="excelgrpthreefive.jsp?transporter=<%=group%>"> <img src="images/excel.jpg" width="15px" height="15px" border="0"/> </a> </div> </td>	
</tr>
</table>
		...
		while(rst.next())
			{
				...
				sql1="select * from t_onlinedata a,t_vehicledetails b where a.VehicleRegNo = '"+vehicleno+"' and a.TheDate < '"+today+"' and a.TheDate > '"+sdays+"' and b.VehicleRegNumber = '"+vehicleno+"' and b.status not in('Deleted','Removed', 'DeActivated') order by a.TheDate Desc";
