...
try
{
	...
	<form name="form1" id="form1" action="" method="post">
				...
				<td colspan="" bgcolor="">  
					<div align="right">  <a href="trnsvehavailexcel.jsp?rep=<%=caller%>&thename=<%=thename %>&tech=<%=caller %>&fromdate=<%=fromdate %>&todate=<%=todate %>"> <img src="images/excel.jpg" width="15px" height="15px" border="0"/> </a> </div> </td>	
...
if(!(null==thename))
{
	...
	<%		sql="select *from t_onlinedata where VehicleRegNo='"+rst.getString("VehRegNo")+"' and (TheDate >='"+rst.getDate("VehAvailDate")+"' or TheDate <'"+rst.getDate("VehAvailDate")+"') order by TheDate Desc";
