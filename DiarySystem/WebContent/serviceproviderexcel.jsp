...
<%@ page import="java.sql.Connection" %>
    ...
    String iShowRows = request.getParameter("iShowRows");
    ...
    System.out.println("The sp i s :"+sp);
    System.out.println("The date is  :"+theDate);
    
    System.out.println("The date is 1 :"+theDate1);
    
    System.out.println("The ipageno i s :"+ipageno);
    System.out.println("The iShowRows is  :"+iShowRows);
    %>
<% 
	
String filename=""+sp+"_service_Provider_Monthly_report_for_"+month+"_"+theDate1+".xls";
...
String MM_dbConn_GPS = "jdbc:mysql://203.199.134.131/airtelnew";
...
int srno=0;
srno = Integer.parseInt(ipageno);
String sqlPagination="SELECT SQL_CALC_FOUND_ROWS * FROM t_subsummarydet WHERE Service_Provider = '"+sp+"' AND DateTime1='"+theDate+" 00:00:00'  order by total desc limit "+ipageno+","+iShowRows+" ";
ResultSet rsPagination =  st.executeQuery(sqlPagination);
System.out.println("The query is in excelllllllll :"+sqlPagination);
