  ...
  <div id="outer">
	...
	<div id="gbox1">
            ...
            <div id="gbox-bg1">
              <div id="gbox-grd1">
<!--- code start here ------>
  <form name="removeunitform" method="get" action="remuittempmultipleinsert.jsp" onsubmit="return validate();">
...
<tr>
			<td colspan="12"><div align="center"><font color="brown" size="3"> <B> Temporary Unit Removal </B> </font></div></td>
		</tr>
<tr>
   <td> <div align="center">
