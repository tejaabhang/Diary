...
<table border="0" width="750px" align="center">
	<tr>
		<td> <div align="center" width="750px"><font color="Brown" size="2">1 to 6 Days Delay Vehicles </font></div>
		</td>
	</tr>
</table>
    ...
    while(s.hasMoreTokens())
		...
		else
		{
         ...
         while(rs1.next())
         {
        	 ...
        	 sql="select * from t_onlinedata where VehicleCode='"+rs1.getString("VehicleCode")+"' and TheDate <'"+today+"' and TheDate >'"+olddate+"'";
        	// out.print(sql);
