...
try
{
	...
	Statement stmt1=con1.createStatement(),stmtinsert=con1.createStatement(),stmt3=con1.createStatement(),stmt2=con1.createStatement();
	ResultSet rs1=null;
	String sql1="";
	String flag="true";
	...
	if(flag.equals("true"))
 	{
   		response.sendRedirect("last3disp.jsp?nounitselected=true&trans="+trans);
   		return;
 	}
	else
 	{
		String[] unid = new String[cntrint];
		String[] orderno = new String[cntrint];
		...
		for(int i=0; i<cntrint; i++) 
     		{
				...
				orderno[i]=request.getParameter("orderno"+i);
				
				String sql2="update t_unitmaster set RecByCust='Yes', RecByCustDate='"+s+"',RecConfirmByRep='"+entby+"' where UnitID='"+unid[i]+"'";
				//System.out.println(sql2);
				stmt2.executeUpdate(sql2);
				
			/* 	sql1="update t_unitmasterhistory set RecByCust='Yes', RecByCustDate='"+s+"' where UnitID='"+unid[i]+"' and OrderNo='"+orderno[i]+"' ";
				...
				sql1="insert into t_unitmasterhistory ("+
						...
						"CommentForTransf,RecByTech,RecByCust,"+
						...
						"'"+rsselect.getString("RecByTech")+"','"+rsselect.getString("RecByCust")+"',"+
				...
				System.out.println("sql1--->"+sql1);stmt3.executeUpdate(sql1);
				
				}
				//String sql3="insert into t_unitmasterhistory select * from db_gps.t_unitmaster where unitID='"+unid[i]+"'";
		...
		response.sendRedirect("last3disp.jsp?updated=yes&trans="+trans);
		return;
	}
}catch(Exception e)
{
