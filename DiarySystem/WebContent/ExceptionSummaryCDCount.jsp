...
<title>Exception Details of CD</title>
...
{  
          ...
          document.ExceptionSummaryCDCount.action ="excel.jsp";
          document.forms["ExceptionSummaryCDCount"].submit();
}
...
<form id="ExceptionSummaryCDCount" name="ExceptionSummaryCDCount" action="" method="post">
	
		<%
		 String  exportFileName="exception_summary_count_CD.xls";
		%>
...
<div style="width:100%;" align="center" id="table1" >
	...
	int count =0;
	String q="";
			sql ="select * from db_gps.t_exceptiondetails where TheDate BETWEEN '"+fDate+"' and '"+tDate+"' and VehID = '"+vehID+"' and ViolationType = 'CD' order by SrNo";
