/*
 ...
 Name			:commonmmenu.js
 Description	:This file creates the actual menu structure.This file should be used in combination with indexmenu.js
 Author			:C.R.Bineesh
 Date			:4Sept2002
...
function dmenu(mnu){
	...
	else
	{
		...
		if(ie55)mt="<IFRAME frameborder=0 id=if"+mnu+" src=\"\" scroll=none style=\"FILTER:progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0);visibility:hidden;height:20;position:absolute;width:"+(menu[3]+ns6w)+"px;left:"+dmleft+"px;top:"+menu[1]+"px;z-index:5\"></iframe>";
