<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 4.01s Strict//EN"
  ...
  <div id="outer">
	...
	<div id="gbox1">
            ...
            <div id="gbox-bg1">
              <div id="gbox-grd1">
<!--- code start here ------>
  <form name="removeunitform" method="get" action="unitmissingmultipleinsert.jsp" onsubmit="return validate();">
...
<table border="0" width="750px" bgcolor="#77D7D4" align="center">
<tr>
			<td colspan="12"><div align="center"><font color="black" size="3"> <B> De-Activation Request  </B> </font></div></td>
		</tr>
<tr>
</table><br></br>
...
for(int k=0;k<cntr;k++)
{
	int c=0;
		...
		String status="";
		String sql44="select * from t_unitreplacement where VehRegNo='"+vehno[k]+"' order by rid DESC limit 1";
		...
		if(rs44.next()){
			...
			if(status.equalsIgnoreCase("Rem")){
				%>
				<tr> <td colspan="40"> 
						<div align="center"> <font color="maroon" size="3">Unit is already Temporary removed for vehicle <%= vehno[k]%>.No need of Deactivation</font></div> 
 			</td>
		</tr>
		...
		<tr>
		 ...
		 Transporter: </b></font>
			...
			<td colspan="14" align="center">  <font size="2"><b>
		      Unit Id: </b></font> </td>
		 	<td>
  		      <input type="text" name="unid<%=k%>" size="8" value="<%=unitid%>" class="formElement" readonly>
  		  	</td>
...
%>
		...
		<!-- <tr>
		 ...
		 <input type="radio" name="oldunitwith" value="Company">Company</input>
			...
			<td align="center"> <font size="2"><b> De-Activation Request as per:</b> </font> </td>
			<td> <input type="radio" name="deactasper<%=k%>" value="Customer"> <b>Customer</b> 
					<input type="radio" name="deactasper<%=k%>" value="Transworld" checked><b>Transworld</b>
					<input type="radio" name="deactasper<%=k%>" value="Barred" > <b>&nbsp;&nbsp;&nbsp;Barred</b>
			</td>
	</tr>
<%
	...
	<tr>
	 ...
	 <input type="hidden" name="cntr" value="<%=l%>">
	 <div align="center"> <input type="submit" name="submit" value="Remove" class="formElement"> </input> </div> </td> 
		</tr>
