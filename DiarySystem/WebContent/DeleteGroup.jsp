  ...
  <div id="outer">
	...
	<div id="gbox1">
            ...
            <div id="gbox-bg1">
              <div id="gbox-grd1">
<!--- code start here ------>
  <form name="removeunitform" method="get" action="insertDeleteGroup.jsp" onsubmit="return validate();">
...
<tr>
			<td colspan="12"><div align="center"><font color="brown" size="3"> <B> Delete Group</B> </font></div></td>
		</tr>
<tr>
   <td> <div align="center">
...
for(int k=0;k<cntr;k++)
{
 ...
 <tr>
      ...
      <td><%=vehno[k]%></td>
<%
String sql4="select Distinct(GPName) from t_group where GPName not like '%del'  and transporter='"+vehno[k]+"'";
ResultSet rs4 = stmt1.executeQuery(sql4);
////System.out.println("sql4-->"+sql4);
%>
      <td>  <font color="maroon">Groups : </font> </td>
      <td>
      <select id="group<%=k%>" name="group<%=k%>" > 
...
<%
	...
	<tr><input type="hidden" name="cntr" value="<%=l%>"></input>
	 <td colspan="14" align="center"> <div align="center"> <input type="submit" name="submit" value="Delete" class="formElement"> </input> </div> </td> 
		</tr>
