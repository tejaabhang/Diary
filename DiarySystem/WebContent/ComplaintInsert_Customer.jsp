...
<%
int Msg=1;
String ReportName="-",website="-",Description="-",tranporter="-",Entby="-",Name="-",EmailID="-",Email1="-",FileName="-",Category="-";
String Priority="-",vehregno="-",vehregno1="-",issues="-",  ClosingComments="-",ClosedBy="-",Status="-",PageName2="-",Email2="-";
email="-";
...
String cmplntype="-",tiger="",cntpersn="-",gpname="-",fromdt="-",todt="-",cntpersn1="-";
...
vehregno=request.getParameter("vehicleregno");
issues=request.getParameter("issues");
tranporter=request.getParameter("transporter");
website=request.getParameter("website");
cntpersn=request.getParameter("cntpersn");
gpname=request.getParameter("gpname");
fromdt=request.getParameter("data1");
todt=request.getParameter("data2");
cntpersn1=request.getParameter("cntctprsn1");

cmplntype=request.getParameter("cmplntype");


vehregno1=request.getParameter("vehicleregno1");
ContactNumber=request.getParameter("Number");

System.out.println("@$$$issues "+issues);
System.out.println("@tranporter "+tranporter);
System.out.println("##@vehregno1 "+vehregno1);
...
System.out.println("\n\n ismultipart-->>"+isMultipart);
	...
	while (itr.hasNext()) {
			...
			if(item.isFormField()) 
			{
				...
				if(name1.equals("cmplntype")) 
				{
					cmplntype = value;
					System.out.println("cmplntype==>"+cmplntype);
					count1 = 1;
				}
				
				
				if(name1.equals("vehicleregno")) 
				{
					vehregno = value;
					System.out.println("vehregno 1==>"+vehregno);
					count1 = 1;
				}
				if(name1.equals("vehicleregno1")) 
				{
					vehregno1 = value;
					System.out.println("vehregno111 @@@@@@@@@221==>"+vehregno1);
					count1 = 1;
				}
				if(name1.equals("transporter")) 
				{
					tranporter = value;
					//System.out.print("\nEmailID 1==>"+Email1);
					count1 = 1;
				...
				if(name1.equals("cntpersn")) 
				{
					cntpersn = value;
					//System.out.print("\nEmailID 1==>"+Email1);
					count1 = 1;
				}
				if(name1.equals("cntctprsn1")) 
				{
					cntpersn1 = value;
					//System.out.print("\nEmailID 1==>"+Email1);
					count1 = 1;
				...
				System.out.println("##@cntpersn "+cntpersn);
				System.out.println("##@gpname "+gpname);
				System.out.println("##@fromdt "+fromdt);
				System.out.println("##@todt "+todt);
				System.out.println("##@cntpersn1 "+cntpersn1);
				System.out.println("##@cmplntype "+cmplntype);

				
				
if(gpname !="" || tranporter !="")
{
	...
	try{
	frmdate=new SimpleDateFormat("yyyy-MM-dd").format(new SimpleDateFormat("dd-MMM-yyyy").parse(fromdt));
	 todate=new SimpleDateFormat("yyyy-MM-dd").format(new SimpleDateFormat("dd-MMM-yyyy").parse(todt));
	}catch(Exception e)
	{
		frmdate="-";
		todate="-";
	...
	if(null!=Description || null!=Category || null!=Priority)
	{
		...
		//Statement st21=null;
		System.out.println("vehregno==$$$$$$$$$$$$44>"+vehregno);
   ...
   try {
			...
			String tomail_cntprsn="-";
			
			try{
				//System.out.println("ComplaintID q :"+ComplaintID);
			String p ="select Email from db_CustomerComplaints.t_recieverinfo where RecieverName like '"+cntpersn1+"%'  ";
			ResultSet rs21 = st21.executeQuery(p);
			System.out.println("query q :"+p);
			if(rs21.next()) {
				tomail_cntprsn = rs21.getString("Email");
			}
			System.out.println("cntpersn EMAIL:"+tomail_cntprsn);
			}catch(Exception e){
		    ...
		    String sqlinsert="insert into t_ComplaintDetail(ReportName,Description,EntBy,Name,EmailID,Email1,ContactNumber,FileName,Category,Priority,ComplaintDateTime,ClosingComment,ClosedBy,Status,Website,PageName,EscalatedDept ,vehicleregno,Issues,Transporter,gpname,contactperson,cmplntfrmdate,cmplnttodate,ComplaintType) "+
			" values('"+ReportName+"','"+Description+"','"+uname+"','"+name+"','"+EmailID+"','"+Email2+"','"+ContactNumber+"','"+savefilestring+"','"+Category+"','"+Priority+"','"+ComplaintDateTime+"','"+ClosingComments+"','"+ClosedBy+"','"+Status+"','"+website+"','-','Service' ,'"+vehregno1+"','"+issues+"','"+tranporter+"','"+gpname+"','"+cntpersn1+"','"+frmdate+"','"+todate+"','"+cmplntype+"' )";	
			...
			String sqlinsert1="insert into t_ComplaintDetailHistory(ComplaintID,ReportName,Description,EntBy,Name,EmailID,Email1,ContactNumber,FileName,Category,Priority,ComplaintDateTime,ClosingComment,ClosedBy,Status,Website,PageName,EscalatedDept,vehicleregno,Issues,Transporter,gpname,contactperson,cmplntfrmdate,cmplnttodate,ComplaintType) "+
			" values('"+comID+"','"+ReportName+"','"+Description+"','"+uname+"','"+name+"','"+EmailID+"','"+Email2+"','"+ContactNumber+"','"+savefilestring+"','"+Category+"','"+Priority+"','"+ComplaintDateTime+"','"+ClosingComments+"','"+ClosedBy+"','"+Status+"','"+website+"','-','Service','"+vehregno1+"','"+issues+"','"+tranporter+"','"+gpname+"','"+cntpersn1+"','"+frmdate+"','"+todate+"','"+cmplntype+"' )";	
			...
			String Data="<html><head><title>Mail Body</title></head><body><table border=^18^ bordercolor=^#E6E6FA^ align=^center^ width=^30%^><tr align=^center^><td align=^left^ style=^border: 0px;^ width=^100%^><table  style=^margin-left: 1em;margin-right: 1em;width: 90%;height: 100%;^><tr><td width=^100%^><a href=^http://www.mobile-eye.in^ target=^_blank^><img src=^http://192.168.2.55:8080/DiarySystem/images/mobile.jpg^ style=^height: 80px; width: 100px;^ title=^Mobile-eye^ id=^logo^ alt=^Logo^ /></a><br/><font style=^color: #D8D8D8^>___________________________________________________________________________</font><br/><br/><div>"
				 +"Hello "+cntpersn1+",<br><br>Thank you for contacting us. This is an automated response confirming the receipt of your complaint. One of our team members will get back to you as soon as possible. "
		...
		/*	String Data="<html><head><title>Mail Body</title></head><body><table border=18 bordercolor=#E6E6FA align=center width=30% ><tr align=center><td align=left style=border: 0px; width=100% ><table  style=margin-left: 1em;margin-right: 1em;width: 90%;height: 100%;><tr><td width=100% ><a href=http://www.mobile-eye.in target=_blank><img src=http://192.168.2.55:8080/DiarySystem/images/mobile.jpg width=100px height=80px title=Mobile-eye id=logo alt=Logo /></a><br/><font color=#D8D8D8>___________________________________________________________________________</font><br/><br/><div>"
            ...
            */          
               ...
               //inset data into all pending mail table   
               		...
               		Email3=Email3+","+emailnew;
                  try{
                	  
                	  String q = "insert into db_gps.t_allpendingmailtable(MailName,Description,MailBody,subjectline,Toid,Tocc,EntryDateTime,MailStatus,SenderName)values('Transworld','New Complaint Email','"+Data+"','Complaint Confirmation - Transworld Compressor Technologies Ltd,Pune','"+tomail_cntprsn+"','"+Email3+"','"+DateTime+"','Pending','Transworld')";
								...
								<div
	                             ...
	                             <br></br>
								   ...
								   <td width="15%"><font size="2" face="Arial"> <b>Email Id </b></font></td><td width="25%"><font size="2"><%=Email1 %></font></td></tr>
								    ...
								    <td width="15%"><font size="2" face="Arial"> <b>Complaint Type </b></font></td><td width="25%"><font size="2" face="Arial"><%=cmplntype %></font></td></tr><tr>
								   ...
								   <td width="15%"><font size="2" face="Arial"><b> Group</b></font></td><td width="25%"><font size="2" face="Arial"><%=gpname %></font></td></tr>  
								    <td width="15%"><font size="2" face="Arial"><b> Transporter</b></font></td><td width="25%"><font size="2" face="Arial"><%=tranporter %></font></td></tr>  
								     <td width="15%"><font size="2" face="Arial"><b> VehicleRegNO </b></font></td><td width="25%"><font size="2" face="Arial"><%=vehregno1 %></font></td></tr>  
								   <td width="15%"><font size="2" face="Arial"><b> Contact Person</b></font></td><td width="25%"><font size="2" face="Arial"><%=cntpersn1 %></font></td></tr>  
								   
								   
								   <td width="15%"><font size="2" face="Arial"><b> Issue</b></font></td><td width="25%"><font size="2" face="Arial"><%=issues %></font></td></tr>
